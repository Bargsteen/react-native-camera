...
public class LimbPositions {
    private int[][] mLimbPositions;

    private static final int BODYPART_COUNT = 14;
    private static final int ROW_COUNT = 96;
    private static final int COL_COUNT = 96;

    public LimbPositions(float[][][] heatmap){
        mLimbPositions = getMaxValues(heatmap);
    }

    public int[][] getLimbPositions() { return mLimbPositions;}
